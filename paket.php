    ...
    <div class="container-fluid p-0">
        ...
        <section id="main-content">
            <section class="wrapper">
                <h3><i class="fa fa-angle-right"></i> Data Paket </h3>
                <!-- BASIC FORM ELELEMNTS -->
                <a href="tambah_paket.php" type="button" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Data Paket</a>
                        ...
                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                echo "<tr>
                                    ...
                                    <td>" . $row['harga'] . "</td>
                                    <td><a href='edit_paket.php?id=$row[id_paket]' type='button' name='edit' class='btn btn-success btn-sm'><i class='fa fa-edit'></i></a>&nbsp;<a href='hapus_paket.php?id=$row[id_paket]' type='button'  name='hapus' id='hapus' class='btn btn-danger btn-sm' onClick='return confirm_hapus()' ><i class='fa fa-trash'></i></a></td>
                                </tr>";
                                $i++;
                            }
                        } else {

...
<body id="page-top">
  ...
  <div class="container-fluid p-0">
    ...
    <section class="resume-section p-3 p-lg-5 d-flex align-items-center" id="about">
      <div class="w-100">
        <h1 class="mb-0">MUSCLE
          <span class="text-primary">GYM</span>
        </h1>
        <div class="subheading mb-5">JALAN. RAMBUTAN, ARIFIN AHMAD, PEKANBARU
          <a href="mailto:name@email.com">musclegympku@gmail.com</a>
        </div>
        <p class="lead mb-5">Get Your Energy With Us!</p>

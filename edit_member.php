...
$id = $_GET['id'];
$sql2 = "SELECT * FROM member WHERE id_member = $id";
    ...
    <div class="container-fluid p-0">
        ...
        <section id="main-content">
            <section class="wrapper">
                <h3><i class="fa fa-angle-right"></i> Form Edit Data Member </h3>
                <!-- BASIC FORM ELELEMNTS -->
                <form method="post" id="form_member" action="proses_edit_member.php">
                    ...
                    <div class="mb-3 col-sm-10">
                        ...
                        <input type="text" class="form-control form-control-sm" name="nama" id="nama" value="<?= $member['nama'] ?>">
                        <span id="error_nama" class="text-danger"></span>
                    </div>
                    <div class="mb-3 col-sm-10">
                        <label for="alamat" class="form-label">Alamat <font color="red">*</font></label>
                        <input type="text" class="form-control form-control-sm" name="alamat" id="alamat" value="<?= $member['alamat'] ?>">
                    ...
                    <div class="mb-3 col-sm-10">
                        ...
                        <input type="text" class="form-control form-control-sm" name="no_hp" id="no_hp" value="<?= $member['no_hp'] ?>">
                    ...
                    <div class="mb-3 col-sm-10">
                        ...
                        <select class="form-control form-control-sm" name="paket" id="paket">
                            ...
                            while ($paket = mysqli_fetch_array($query)) {
                                if ($paket['id_paket'] == $member['id_paket']) {
                    ...
                    <div class="mb-3 col-sm-10">
                        ...
                        <input type="text" class="form-control form-control-sm" name="harga" id="harga" value="<?= $member['harga'] ?>">
                    </div>
                    <div class="mb-3 col-sm-10">
                        <label for="tanggal_mulai" class="form-label">Tanggal Mulai <font color="red">*</font></label>
                        <input type="date" class="form-control form-control-sm" name="tanggal_mulai" id="tanggal_mulai" value="<?= $member['tanggal_mulai'] ?>">
                    ...
                    <div class="mb-3 col-sm-10">
                        ...
                        <input type="date" class="form-control form-control-sm" name="tanggal_akhir" id="tanggal_akhir" value="<?= $member['tanggal_akhir'] ?>">
